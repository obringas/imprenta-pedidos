      ...
      <div class="mobile-sheet-backdrop" (click)="cerrarFiltrosMobile()">
        <section class="mobile-sheet card filters-stack" (click)="$event.stopPropagation()">
          ...
          <div class="filters-actions">
            ...
            <span class="caption">{{ totalPedidosFiltrados() }} pedidos encontrados</span>
            <button type="button" class="primary-button" (click)="cerrarFiltrosMobile()">Ver {{ totalPedidosFiltrados() }} pedidos</button>
          </div>
        </section>
      </div>
    }
...
export class PedidosListaPageComponent {
  ...
  protected readonly totalPedidosFiltrados = computed(() => this.facade.pedidosFiltrados().length);
